...
namespace Aucent.MAX.AXE.Common.ZipCompressDecompress.Zip
{
	...
	public class ZipEntry : ICloneable
	{
		...
		/// </returns>
		/// <see cref="Aucent.MAX.AXE.Common.ZipCompressDecompress.Zip.CompressionMethod.Deflated"/>
		/// <see cref="Aucent.MAX.AXE.Common.ZipCompressDecompress.Zip.CompressionMethod.Stored"/>
