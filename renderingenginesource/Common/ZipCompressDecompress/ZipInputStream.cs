...
using Aucent.MAX.AXE.Common.ZipCompressDecompress.Checksums;
using Aucent.MAX.AXE.Common.ZipCompressDecompress.Zip.Compression;
using Aucent.MAX.AXE.Common.ZipCompressDecompress.Zip.Compression.Streams;

namespace Aucent.MAX.AXE.Common.ZipCompressDecompress.Zip 
{
	/// <summary>
	...
	public class ZipInputStream : InflaterInputStream
	{
		...
		/// </exception>
		/// <exception name="Aucent.MAX.AXE.Common.ZipCompressDecompress.ZipException">
