...
namespace Aucent.MAX.AXE.Common.ZipCompressDecompress.Zip.Compression.Streams 
{
	...
	/// as the <see cref="Aucent.MAX.AXE.Common.ZipCompressDecompress.GZip.GZipInputStream">GZipInputStream</see>.
	///
