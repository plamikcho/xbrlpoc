...
namespace Aucent.MAX.AXE.XBRLParser.Test_Taxonomy
{
	...
	/// <exclude/>
	[TestFixture] 
	public class TestTaxonomy_IBM_20080226 : Taxonomy
	{
		#region init
		...
		string IBM_FILE = TestCommon.FolderRoot + @"ibm-20080226" + System.IO.Path.DirectorySeparatorChar + "ibm-20080226.xsd";
		...
		public void IBM_LoadAndParse()
		{
			...
			TestTaxonomy_IBM_20080226 taxonomy = new TestTaxonomy_IBM_20080226();

			int errors = 0;

			if (taxonomy.Load(IBM_FILE, out errors) != true)
			{
