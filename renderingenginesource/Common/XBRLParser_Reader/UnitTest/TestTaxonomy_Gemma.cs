...
namespace Aucent.MAX.AXE.XBRLParser.Test_Taxonomy
{
	...
	/// <exclude/>
	[TestFixture] 
	public class TestTaxonomy_Gemma : Taxonomy
	{
		#region init
		/// <exclude/>
		[TestFixtureSetUp]
		...
		string GEMMA_FILE = TestCommon.FolderRoot + @"Gemma" +System.IO.Path.DirectorySeparatorChar +"gemma-br-2005-01-31.xsd";
