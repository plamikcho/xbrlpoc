...
namespace Aucent.MAX.AXE.XBRLReportBuilder.Data
{
	public abstract partial class Test_Abstract
	{
		...
		public static int natcasecmp( IFileInfo left, IFileInfo right )
		{
			return natcasecmp( left.Name, right.Name );
		}

		public static int natcasecmp( string left, string right )
		{
