...
%compiler% /out ..\..\BuildLog.txt /rebuild Debug "..\..\Common\Common.sln"

ECHO. >> ..\..\BuildLog.txt
ECHO. >> ..\..\BuildLog.txt
ECHO. >> ..\..\BuildLog.txt
ECHO ********Building NXBRE******** >> ..\..\BuildLog.txt
%compiler% /out ..\..\BuildLog.txt /rebuild Debug "..\..\XBRLReportBuilder\NxBRE\NxBRE.sln"

ECHO. >> ..\..\BuildLog.txt
ECHO. >> ..\..\BuildLog.txt
ECHO. >> ..\..\BuildLog.txt
ECHO ********Building FilingServices******** >> ..\..\BuildLog.txt
%compiler% /out ..\..\BuildLog.txt /rebuild Debug "..\..\XBRLReportBuilder\FilingServices\FilingServices.sln"

ECHO. >> ..\..\BuildLog.txt
ECHO. >> ..\..\BuildLog.txt
ECHO. >> ..\..\BuildLog.txt
ECHO ********Building XBRLReportBuilder******** >> ..\..\BuildLog.txt
%compiler% /out ..\..\BuildLog.txt /rebuild Debug "..\..\XBRLReportBuilder\XBRLReportBuilder\XBRLReportBuilder.sln"
